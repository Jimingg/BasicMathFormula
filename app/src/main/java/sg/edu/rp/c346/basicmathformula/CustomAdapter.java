...
public class CustomAdapter extends ArrayAdapter{
    ...
    int layout_id;
    ArrayList<ForumlaItem> forList;
    public CustomAdapter(@NonNull Context context, int resource, @NonNull ArrayList<ForumlaItem> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ForumlaItem currentItem = forList.get(position);
